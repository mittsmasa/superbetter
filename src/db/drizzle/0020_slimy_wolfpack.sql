...
ALTER TABLE `account` ADD `createdAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;--> statement-breakpoint
ALTER TABLE `account` ADD `updatedAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;--> statement-breakpoint
ALTER TABLE `session` ADD `id` varchar(36);--> statement-breakpoint
ALTER TABLE `session` ADD `createdAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;--> statement-breakpoint
ALTER TABLE `session` ADD `updatedAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;--> statement-breakpoint
...
ALTER TABLE `verificationToken` ADD `createdAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;--> statement-breakpoint
ALTER TABLE `verificationToken` ADD `updatedAt` timestamp(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL;